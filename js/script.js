const API_URL = "https://flash-sponge-orca.glitch.me/";
...
const createCard = (item) => {
  ...
  coctail.classList.add("coctail");

  coctail.innerHTML = `
    <img src="${API_URL}${item.image}" alt=" Коктейль ${item.title}" class="coctail__img" />
...
const createCartItem = (item) => {
  ...
  li.innerHTML = ` 
    <img src="img/6.jpg" alt="${item.title}" class="order__img">
